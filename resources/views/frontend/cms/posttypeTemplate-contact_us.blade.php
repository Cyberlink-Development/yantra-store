        ...
        <div class="row">
            ...
            <div class="col-md-6 ">
                <div class="mt-5 d-none d-md-block ">
                    <img src="{{ $data->banner ? asset('uploads/banners/' . $data->banner) : asset('theme-assets/img/contact.jpg') }}"
                        class="shadow rounded" style="height:560px; object-fit:cover;" alt="{{ $data->post_type }}" />
                </div>
            </div>
        </div>
