  ...
  <div class="cz-handheld-toolbar">
      <div class="d-table table-fixed w-100">
          ...
          <a id="mblCart" class="d-table-cell cz-handheld-toolbar-item" href="{{route('cart-item')}}">
            <span class="cz-handheld-toolbar-icon uk-cart-count">
                <i class="czi-cart font-secondary"></i>
                <span class="badge badge-primary badge-pill ml-1" style="padding: 4px 6px;">{{Cart::count()}}</span>
                <span class="cz-handheld-toolbar-label">Cart</span>
          </a>
      </div>
  </div>
