            ...
            <div class="accordion mt-n1" id="shop-categories">
                ...
                <div class="card border-bottom">
                    <div class="card-header">
                        <h3 class="accordion-heading"><a class="collapsed" href="#shoes" role="button" data-toggle="collapse" aria-expanded="false" aria-controls="shoes">Brands<span class="accordion-indicator"></span></a></h3>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="widget widget-links cz-filter">
                                <ul class="widget-list cz-filter-list pt-1" style="height: 12rem;" data-simplebar data-simplebar-auto-hide="false">
                                    ...
                                    <li class="widget-list-item cz-filter-item">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="ex-check-0">
                                            <label class="custom-control-label" for="ex-check-0">Dell</label>
                                        </div>
                                    </li>
                                    <li class="widget-list-item cz-filter-item">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="ex-check-9">
                                            <label class="custom-control-label" for="ex-check-9">Acer</label>
                                        </div>
                                    </li>
                                    <li class="widget-list-item cz-filter-item">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="ex-check-90">
                ...
                <div class="card border-bottom">
                    <div class="card-header">
                        <h3 class="accordion-heading"><a class="collapsed" href="#type" role="button" data-toggle="collapse" aria-expanded="false" aria-controls="shoes">Type<span class="accordion-indicator"></span></a></h3>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="widget widget-links cz-filter">
                                <ul class="widget-list cz-filter-list pt-1" style="height: 12rem;" data-simplebar data-simplebar-auto-hide="false">
                                    ...
                                    <li class="widget-list-item cz-filter-item">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="ex-check-a">
                                            <label class="custom-control-label" for="ex-check-a">Notebook</label>
                                        </div>
                                    </li>
                                    <li class="widget-list-item cz-filter-item">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="ex-check-b">
                                            <label class="custom-control-label" for="ex-check-b">Ultrabook</label>
                                        </div>
                                    </li>
                                    <li class="widget-list-item cz-filter-item">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="ex-check-c">
                        ...
                        <div class="card-body">
                            <div class="widget widget-links cz-filter">
                                <ul class="widget-list cz-filter-list pt-1" style="height: 12rem;" data-simplebar data-simplebar-auto-hide="false">
                                    <li class="widget-list-item cz-filter-item">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="ex-check-10">
                                            <label class="custom-control-label" for="ex-check-10">Notebook</label>
                                        </div>
                                    </li>
                                    <li class="widget-list-item cz-filter-item">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="ex-check-11">
                                            <label class="custom-control-label" for="ex-check-11">Ultrabook</label>
                                        </div>
                                    </li>
                                    <li class="widget-list-item cz-filter-item">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="ex-check-12">
                                            <label class="custom-control-label" for="ex-check-12">Standard</label>
                                        </div>
                                    </li>
                                    <li class="widget-list-item cz-filter-item">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="ex-check-q">
                                            <label class="custom-control-label" for="ex-check-q">Notebook</label>
                                        </div>
                                    </li>
                                    <li class="widget-list-item cz-filter-item">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="ex-check-w">
                                            <label class="custom-control-label" for="ex-check-w">Ultrabook</label>
                                        </div>
                                    </li>
                                    <li class="widget-list-item cz-filter-item">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="ex-check-e">
                ...
                <div class="d-flex justify-content-center">
                    <a class="btn btn-primary  " href="shop-grid-ls.php">Filter Products <span><i style="font-size: 12px;" class="czi-arrow-right ml-1 mr-1 font-weight-bold "></i></span></a>
                </div>
            </div>
        </div>
