            ...
            <div class="navbar-sticky bg-light">
                <div class="navbar navbar-expand-lg navbar-light">
                    <div class="container">
                        ...
                        <a class="navbar-brand d-none d-sm-block mr-3 flex-shrink-0 p-0" href="{{url('/')}}"
                            style="min-width: 7rem;">
                            <img width="60" src="{{ asset('theme-assets/img/logo.jpg') }}" alt="Cyberlink" />
                        </a>

                        <a class="navbar-brand d-sm-none mr-2" href="{{ url('/') }}"
                    ...
                    <i class="navbar-tool-icon czi-heart"></i>
                            ...
                            @if(Auth::check())
                                <a class="navbar-tool ml-2 ml-lg-0 mr-n1 mr-lg-2" href="{{route('user-profile')}}">
                                    <div class="navbar-tool-icon-box bg-secondary">
                                        <i class="navbar-tool-icon czi-user"></i>
                                    </div>
                                    <div class="navbar-tool-text ml-1"><small>Hello, {{Auth::user()->first_name ? ucfirst(Auth::user()->first_name) : 'User' }}</small>My Account</div>
                                </a>
                            @else
