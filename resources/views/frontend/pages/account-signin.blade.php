  ...
  <section class="uk-section uk-background-muted uk-section-muted uk-flex uk-flex-middle">
    ...
    <div class="modal-content">
      ...
      <form method="post" action="{{route('login')}}" class="needs-validation tab-pane fade show active"
        ...
        <div class="d-inline-block align-middle">Login With: <a class="social-btn sb-google mr-2 mb-2" href="#"
          data-toggle="tooltip" title="" data-original-title="Sign in with Google"><i class="czi-google"></i></a>
        </div>
        </div>
