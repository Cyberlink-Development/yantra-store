                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="parent_id" id="parent"class="form-control select2">
                                            ...
                                            @foreach ($category as $value1)
                                                <option @if ($value->parent_id == $value1->id) selected @endif
                                                    value="{{ $value1->id }}">{{ $value1->name }}</option>
                                    ...
                                    @if ($value->banner)
                                        <div id="prev-banner">
                                            <button type="button" class="btn btn-danger"
                                                data-url="{{ route('category-banner-delete', $value->id) }}"
                                                id="banner-delete">X</button>
                                            <p class="mt-4">
                                    ...
                                    @if ($value->image)
                                        <div id="prev-img">
                                            <button type="button" class="btn btn-danger"
                                                data-url="{{ route('category-image-delete', $value->id) }}"
                                                id="image-delete">X</button>
                                            <p class="mt-4">
                                    ...
                                    <div class="form-group special-link">
                                        ...
                                        <select class="form-control" name="status" id="isSpecial">
                                            <option @if ($value->status == 0) selected @endif value="0">No
                                            </option>
                                            <option @if ($value->status == 1) selected @endif value="1">Yes
                                            </option>
                                        </select>
                                    ...
                                    <div class="form-group special-link">
                                        ...
                                        <select class="form-control" name="is_special" id="isSpecial">
                                            <option @if ($value->is_special == 0) selected @endif value="0">No
                                            </option>
                                            <option @if ($value->is_special == 1) selected @endif value="1">Yes
                                            </option>
                                        </select>
                                        <span class="help-block"
                                            style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $value->seo_keyword }}" name="seo_keyword"
                                            id="seo_keyword" class="form-control">
                                    </div>
