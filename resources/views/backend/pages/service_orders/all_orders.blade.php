            ...
            @foreach($order as $key=>$value)
                <tr>
                    ...
                    <td>
                        ...
                        @elseif($value->address?->first_name)
                            {{ $value->address?->first_name }} {{ $value->address?->last_name }}
                        @else
                            Anonymous
                        @endif
                    </td>
                    ...
                    <td>
                        <a class="btn btn-primary" href="{{route('service_order_details',$value->id)}}"><i class="fa fa-eye"></i> </a>

                        <a class="btn btn-danger confirm"
                           href="{{route('service-order-delete',$value->id)}}"
